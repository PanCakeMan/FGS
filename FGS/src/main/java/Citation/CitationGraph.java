...
public class CitationGraph extends DataGraphBase {
    ...
    public  void loadCitationGraph (String filePath) throws IOException {
...
//                            System.out.println(ss.replace("\"", ""));
    ...
    public static void main(String args[]) throws IOException {
        ...
        Linkedin.LinkedinGraph graph  = new Linkedin.LinkedinGraph();
