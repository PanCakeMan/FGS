...
public class VF2Checker2 {
    ...
    public VF2Checker2(MovieDataGraph linkedinGraph) {
            ...
            if (flag) {
                ...
                if (!canSkip) {
                    ...
                    for (int l = 0; l < curMiningCandidates.size(); l++) {
                        ...
                        HashMap<Integer, HashSet<RelationshipEdge>> curSetSum = new HashMap<>();
                        for (int key : resultPatterns.keySet()) {
                            curSetSum.put(key, setSummary.get(key));
                        }
...
//        System.out.println("ratio " + ratio1);
        ...
        long startTime = System.nanoTime();
//
        ArrayList<Graph<DataNode, RelationshipEdge>> miningCandidates = algoGSPAN.runAlgorithm(targetGraphList, "outputPattern.txt", 1,
                        false, false, 5, false, nodeLabelMap, edgeLabelMap);
...
//            System.out.println("add");
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        VF2Checker2 checker = new VF2Checker2(graph);
...
//        cc.add(new Rangepair(20, 40));
        ...
        long startTime = System.nanoTime();
        checker.runMaxSumGen(group, cc, 1, 50);
